        ...
        <Card key={member.id}>
          <CardContent className="p-6 flex flex-col items-center text-center">
            ...
            <div className="flex gap-2 w-full">
                ...
                <Button variant="outline" size="sm" className="w-full text-destructive hover:text-destructive hover:bg-destructive/10 border-destructive/50 hover:border-destructive/80">
